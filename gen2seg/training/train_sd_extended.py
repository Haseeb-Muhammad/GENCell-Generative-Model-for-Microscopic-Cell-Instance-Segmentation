...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="Gen2Seg_sd_extended_dataset",
...
def main():
    ...
    def validation(epoch, global_step):
        ...
        log_image = [0, 1860, 3007, 873, 185, 1680, 1139, 482, 1606, 1817, 578]
    ...
    ## EDIT THESE PATHS
    fluo_root = "/ds/images/microscopy_3D/extended_set_2D_z_only/"
    train_dataset_fluo = ExtendedCell(root_dir=fluo_root, split="train")
    val_dataset_fluo = ExtendedCell(root_dir=fluo_root, split="val")
    ...
    # # resuming
    # path = "/netscratch/muhammad/codes/gen2seg/training/model-finetuned/stable_diffusion_extendedDatasetAllSlicesExtendedTraining/Epoch-20"
    # accelerator.print(f"Resuming from epoch {path}")
    # accelerator.load_state(os.path.join(args.output_dir, path))
    # global_step = 67663
    # initial_global_step = global_step
    # first_epoch = 21
